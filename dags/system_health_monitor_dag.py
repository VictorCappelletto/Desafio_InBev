...
def check_azure_sql_health(**context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        result = {"component": "Azure SQL", "status": "unhealthy", "error": str(e)}
...
def check_databricks_health(**context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        result = {"component": "Databricks", "status": "unhealthy", "error": str(e)}
...
def check_brewery_api_health(**context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        result = {"component": "Brewery API", "status": "unhealthy", "error": str(e)}
...
def check_airflow_health(**context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        result = {"component": "Airflow", "status": "unhealthy", "error": str(e)}
        ...
        for component in components:
            if component:
                ...
                logger.info(
                    ...
                    else f"{status_icon} {component['component']}: {component['status'].upper()}"
                )
