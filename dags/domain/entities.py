...
class Brewery:
    ...
    def is_complete(self) -> bool:
        ...
        return (
            ...
            self.contact is not None and
            self.contact.has_any()
        )
    ...
    def __str__(self) -> str:
        ...
        return f"Brewery(id='{self.id}', name='{self.name}', type='{self.brewery_type}')"
...
class BreweryAggregate:
    ...
    def can_be_processed(self) -> bool:
        ...
        """
        return (
            self.validate_consistency() and
            self.brewery.is_active() and
            self.brewery.has_location()
        )
